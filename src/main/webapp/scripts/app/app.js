...
angular.module('reportsApp', ['LocalStorageModule', 'tmh.dynamicLocale', 'pascalprecht.translate', 
    ...
    .run(function ($rootScope, $location, $window, $http, $state, $translate, Language, Auth, Principal, ENV, VERSION) {
        ...
        var neg = angular.element(document).find('.main-header').outerHeight() + angular.element(document).find('.main-footer').outerHeight();
        var window_height = $window.innerHeight;
        var sidebar_height = angular.element(document).find(".sidebar").height();
        if (window_height >= sidebar_height) {
            $rootScope.minHeight = window_height - neg;
        } else {
            $rootScope.minHeight = sidebar_height;
        }
    ...
    .config(function ($stateProvider, $urlRouterProvider, $httpProvider, $locationProvider, $translateProvider, tmhDynamicLocaleProvider, httpRequestInterceptorCacheBusterProvider, AlertServiceProvider) {
        ...
        $stateProvider.state('site', {
            ...
            views: {
                'navbar@': {
                    templateUrl: 'scripts/components/navbar/navbar-lte.html',
                    controller: 'NavbarController'
                },
                'sidebar@': {
                    templateUrl: 'scripts/components/navbar/sidebar.html'
                }
            },
            resolve: {
                authorize: ['Auth',
